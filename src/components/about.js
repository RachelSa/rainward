...
const About = () => {
  return (
    <div class="paragraph-text">
      ...
      <p>The Wool Sock Rating of displayed destinations can be used to determine how dreary the top-ranked cities are forecasted to be. Three wool socks indicates lots of inclement weather in the forecast. Two wool indicates some inclement weather. One wool sock indicates little or no inclement weather.</p>
